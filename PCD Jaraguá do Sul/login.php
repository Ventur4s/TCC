...
if($linha>0){
    ...
    $link = "<a href='index.html' class='button-login'>Ir para página principal</a>";
} else {
    $message = "Usuário, senha ou CPF incorretos.";
    $link = "<a href='entrar.html' class='button-login'>Voltar</a>";
}
